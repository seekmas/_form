...
class CatalogsControllerTest < ActionController::TestCase
  ...
  test "should create catalog" do
    assert_difference('Catalog.count') do
      post :create, catalog: { description: @catalog.description, enabled: @catalog.enabled, subject: @catalog.subject }
    end
  ...
  test "should update catalog" do
    patch :update, id: @catalog, catalog: { description: @catalog.description, enabled: @catalog.enabled, subject: @catalog.subject }
    assert_redirected_to catalog_path(assigns(:catalog))
  end
