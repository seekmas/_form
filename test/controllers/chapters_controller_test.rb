...
class ChaptersControllerTest < ActionController::TestCase
  ...
  test "should create chapter" do
    assert_difference('Chapter.count') do
      post :create, chapter: { content: @chapter.content, father_id: @chapter.father_id, subject: @chapter.subject }
    end
  ...
  test "should update chapter" do
    patch :update, id: @chapter, chapter: { content: @chapter.content, father_id: @chapter.father_id, subject: @chapter.subject }
    assert_redirected_to chapter_path(assigns(:chapter))
  end
